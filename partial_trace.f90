...
!-----------------------------------------------------------------------------------------------------------------------------------
subroutine partial_trace_a_he(rho, da, db, rho_b)  ! Returns the left partial trace (over a), for a bi-partite matrix
implicit none
...
!-----------------------------------------------------------------------------------------------------------------------------------
subroutine partial_trace_b_he(rho, da, db, rho_a)  ! Returns the right partial trace (over b), for a bi-partite matrix
implicit none
integer, intent(in) :: da, db ! Dimensions of the subsystems (the dimension of the whole system is d = da*db)
complex(8), intent(in) :: rho(1:da*db,1:da*db)  ! Bipartite matrix (computational basis representation of the ragarded operator)
...
!-----------------------------------------------------------------------------------------------------------------------------------
subroutine partial_trace_3_he(rho, da, db, dc, rho_ac)  ! Returns the inner partial trace for a three-partite matrix
implicit none
...
!###################################################################################################################################
! The next four subroutines are used, and needed, for computing the partial trace for general multi-partite systems
! (for GENERAL matrices), (OPTMIZED version)
